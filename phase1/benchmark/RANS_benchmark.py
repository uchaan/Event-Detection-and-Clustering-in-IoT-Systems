...
if __name__ == "__main__":
    ...
    for entity in params["entities"]:
        ...
        train_anomaly_score = model.predict_prob(x_train, N, batch_size=10 * params["batch_size"])

        tt.test_start()
        anomaly_score = model.predict_prob(x_test, N, batch_size=10 * params["batch_size"])
        tt.test_end()
