...
if __name__ == "__main__":
    ...
    for entity in params["entities"]:
        ...
        tt.test_start()
        anomaly_score, anomaly_label = model.predict_prob(test_loader, test_windows_label)
        tt.test_end()

        train_anomaly_score, anomaly_label = model.predict_prob(train_loader, test_windows_label)
